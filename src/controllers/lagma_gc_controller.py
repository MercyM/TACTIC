...
from TRAMA_release_pymarl.src.controllers.dmcg_controller import DeepCoordinationGraphMAC
...
class LAGMAMAC_GC:
    def __init__(self, scheme, groups, args):
        ...
        # 新增DMCG协调图组件
        self.dcg = DeepCoordinationGraphMAC(scheme, groups, args)
    ...
    def forward(self, ep_batch, t, goal_latent=None, test_mode=False, selected_goal=None, actions=None,
                policy_mode=True, compute_grads=False):
        ...
        dcg_outs = self.dcg.forward(ep_batch, t, actions=actions, policy_mode=policy_mode, test_mode=test_mode,
        ...
        return agent_outs.view(ep_batch.batch_size, self.n_agents, -1), \
               ...
               (None if selected_goal_latent is None else selected_goal_latent.view(ep_batch.batch_size, self.n_agents,
                                                                                    -1))
    ...
    def select_action_only(self, ep_batch, t, goal_latent=None, selected_goal=None):
        ...
        selected_goal_latent = th.gather(goal_latent_exp, 1,
                                         selected_goal_index.unsqueeze(-1).unsqueeze(-1).repeat(1, 1,
                                                                                                self.latent_dim)).squeeze(
            1)
