...
class LAGMAGCLearner:
    def __init__(self, mac, vqvae, scheme, logger, args):
        self.args = args
        self.mac = mac
        self.dcg_learner = DMCGLearner(mac, scheme, logger, args)
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, seq_centroid=None, RBS_cluster=None,
        ...
        #########################图训练############################################
        self.dcg_learner.train(batch, t_env, episode_num)
        ...
        self.dcg_learner.mac.init_hidden(batch.batch_size)
        ...
        self.dcg_learner.target_mac.init_hidden(batch.batch_size)
